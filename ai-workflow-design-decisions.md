...
The design decisions for `ai-workflow.md` have been split into topic-scoped files in the `ai-workflow-design-decisions/` folder.
...
- [observed-ai-failings-guide.md](ai-workflow-design-decisions/observed-ai-failings-guide.md) — Instructions and entry template for `observed-ai-failings.md`.
