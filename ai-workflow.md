...
`north-star.md`, if it exists, is the intent oracle: consult it before interrupting the human with a question of preference, and ask where it is silent. aiw-north-star owns it.
