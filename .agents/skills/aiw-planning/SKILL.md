...
The oracle above settles what is correct. Where the approach turns on what the project is trying to achieve, `north-star.md` settles that; record what it settled. See aiw-north-star.
