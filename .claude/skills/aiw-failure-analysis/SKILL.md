...
This skill is reactive. The core skills (aiw-ground-truth, aiw-testing, aiw-verification, aiw-validation, aiw-housekeeping) are proactive — they keep the loop honest. This skill runs when the loop failed anyway, and audits the core skills to find where the gap opened.
