...
- Confirm the body carries aiw-validation's line: the deliverable, how it was met, and the end impact as delivered and for which user. Confirm it carries aiw-housekeeping's line too: what was removed or moved, or that nothing was. (Why: a check that leaves nothing behind cannot be told apart from a check that was skipped, and the human decides after the pull request is open, not before.)
